      ...
      <div className="bg-white w-full  sm:h-[720px] sm:w-[540px] mx-auto sm:rounded-[40px] py-[22px] px-4 sm:shadow-[0_8px_20px_0_rgba(0,0,0,0.2)] z-50">
        ...
        <div className="max-w-[328px] mx-auto h-[537px] mt-[63px] sm:mt-5">
          ...
          <div className="mt-5 flex items-center justify-center">
            <button className="ff_inter font-semibold text-base text-[#000000]">Already have an account?  </button>
            <button className="ff_inter font-semibold text-base text-[#4D8AFF] ms-2">Sign In</button>
          </div>
        </div>
      </div>
    </div>
