...
import VerifyPopUp from "../LoginSignup/VerifyPopUp";

function SignUpPopUp({ hendlVerify, popuoClose, closeSignUpPopUp }) {
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center h-screen ">
        <div className="bg-white w-full  sm:h-[720px] sm:w-[540px] mx-auto sm:rounded-[40px] py-[22px] px-4 sm:shadow-[0_8px_20px_0_rgba(0,0,0,0.2)] z-50">
          <div className="flex items-center justify-between">
            <button onClick={closPopUp}>
              <img className="w-[16px]" src={BackIcon} />
            </button>
            <button onClick={closPopUp} className="hidden sm:block">
              <img className="w-[26px]" src={CloseIcon} />
            </button>
          </div>
          <div className="max-w-[328px] mx-auto h-[537px] mt-[63px] sm:mt-5">
            <h1 className="text-black ff_inter font-bold text-xl">Sign Up</h1>
            ...
            <div className="mt-5 flex items-center justify-center">
              <button className="ff_inter font-semibold text-base text-[#000000]">
                Already have an account?{" "}
              </button>
              <button
                onClick={handleSignInClick}
                className="ff_inter font-semibold text-base text-[#4D8AFF] ms-2"
              >
                Sign In
              </button>
            </div>
