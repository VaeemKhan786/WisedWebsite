...
export default function VerifyPopUp() {
  return (
    <>
      ...
      <div className="bg-red-700 shadow-[0_8px_20px_0_rgba(0,0,0,0.2)]">
        <div className="max-md:h-screen md:w-[540px] w-full bg-white popup_shadow md:rounded-[40px] py-5 sm:py-9 max-sm:px-[10px] fixed top-0 start-0 md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 z-[50]">
