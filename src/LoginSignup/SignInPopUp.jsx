      ...
      <div className="max-md:h-screen md:max-w-[540px] w-full bg-white popup_shadow md:rounded-[40px] py-7 xl:py-9 mx-auto fixed top-0 start-0 md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 z-[50]">
        <div className="bg-white w-full sm:h-[640px] sm:w-[540px] mx-auto sm:rounded-[40px] py-10 px-4 sm:shadow-[0_8px_20px_0_rgba(0,0,0,0.2)] z-50">
          ...
          <div className="max-w-[328px] mx-auto h-[537px] mt-[63px] sm:mt-5">
            ...
            <button className="text-white font-normal ff_inter text-base py-[19px] lg:py-4 w-full bg-[#4D8AFF] rounded-[100px] mt-5">
              Sign In
            </button>
